    ...
    <div>
      <div className="grid gap-4">
        ...
        {data.map((user, index) => (
          <div
            key={index}
            className="rounded-3xl p-3 flex  items-center bg-slate-300 "
          >
            ...
            <div className="font-bold font-sans ml-5 lg:text-3xl text-left text-2xl uppercase">
              {user.username}
            </div>

            <div className="font-bold font-sans ml-auto text-right text-3xl">
              {user.points}
            </div>
            ...
            {index === 0 ? (
              <img
                ...
                className="lg:h-20 w-32 lg:pr-5 h-10"
              />
            ) : index === 1 ? (
              <img
